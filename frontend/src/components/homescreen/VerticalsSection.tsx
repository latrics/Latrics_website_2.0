...
export default function VerticalsSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center bg-black overflow-hidden pt-20">
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto px-6 md:px-12 lg:px-16 xl:px-20 flex flex-col md:flex-row items-center justify-between min-h-[calc(100vh-5rem)]">
